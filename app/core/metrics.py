...
payments_duplicate_blocked_total = Counter(
    "payments_duplicate_blocked_total",
    "Total of duplicate attempts blocked by idempotency",
)
...
consumer_events_processed_total = Counter(
    ...
    "Total of events processed successfully by the consumer",
)
consumer_events_duplicate_total = Counter(
    "consumer_events_duplicate_total",
    "Total of duplicate events ignored by the consumer",
)
